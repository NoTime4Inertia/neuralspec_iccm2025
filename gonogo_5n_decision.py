...
with model:
    ...
    obs = spa.State(obs_vocab, neurons_per_dimension = 5)
    
    hc_obs = spa.State(hc_vocab, neurons_per_dimension = 5)
    hc_ppc = spa.State(hc_vocab, neurons_per_dimension = 5)
    ...
    assoc_ppc = spa.State(assoc_ppc_vocab, neurons_per_dimension = 5)
